...
class LoginFrameOgretim extends JFrame implements ActionListener{
    ...
    public LoginFrameOgretim(){
        try {
            this.ogretim = new OgretimUyesi();
        } catch (IOException ex) {
            Logger.getLogger(LoginFrameOgretim.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        this.setLayout(null);
        this.setTitle("Öğretim Üyesi Penceresi");
        this.add(şifrel);
        this.add(pass);
        this.add(login1);
        this.add(id);
